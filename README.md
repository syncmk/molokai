...
[tomasr/molokai](https://github.com/tomasr/molokai) has perfect color selection, but italics are hard to read in some environment.
Italicization has been removed from this fork of tomasr/molokai.
...
If you prefer the scheme to match the original molokai italic style, put this in your .vimrc file: 
```
let g:molokai_italic = 1
```
